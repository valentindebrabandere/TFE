...
defaultAppsByStyle.set('oneBit', [
  ...
  { id: 'Preview', filelink: '/content/oneBit/desktop/entreprise/logo.png', childItems: [], top: 5, left: 2 },
]);
...
defaultAppsByStyle.set('skeuo', [
  { id: 'Preview', filelink: '/content/skeuo/desktop/desktopImages/bourse.png', childItems: [], top: 15, left: 8 },
  { id: 'Preview', filelink: '/content/skeuo/desktop/desktopImages/news2.png', childItems: [], top: 8, left: 60 },
  { id: 'Preview', filelink: '/content/skeuo/desktop/desktopImages/news.png', childItems: [], top: 2, left: 10 },
...
defaultAppsByStyle.set('flat', [
  ...
  { id: 'Preview', filelink: '/content/flat/desktop/desktopImages/voleur.png', childItems: [], top: 12, left: 20 },
]);
//Modern Mac
defaultAppsByStyle.set('modernMac', [
  { id: 'TextEdit', filelink: '/content/modernMac/desktop/lettre.html', childItems: [], top: 10, left: 25 },
  { id: 'Preview', filelink: '/content/modernMac/desktop/desktopImages/Yuna 1.jpeg', childItems: [], top: 8, left: 8 },
  { id: 'Preview', filelink: '/content/modernMac/desktop/desktopImages/Yuna 8.jpeg', childItems: [], top: 5, left: 55 },
  { id: 'Preview', filelink: '/content/modernMac/desktop/desktopImages/Yuna 2.jpeg', childItems: [], top: 10, left: 25 },
